defmodule ArbitronWeb.Router do
  use ArbitronWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {ArbitronWeb.LayoutView, :root}
