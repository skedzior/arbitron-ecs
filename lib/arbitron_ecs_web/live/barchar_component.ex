defmodule ArbitronWeb.BarChartComponent do
...
defmodule ArbitronWeb.MultiBarChart do
  ...
  def render(assigns) do
    ...
    <section class="row">
      <article class="column">
        <%= live_component @socket, ArbitronWeb.BarChartComponent, id: 1 %>
      </article>
      <article class="column">
        <%= live_component @socket, ArbitronWeb.BarChartComponent, id: 2 %>
      </article>
    </section>
    <section class="row">
      <article class="column">
        <%= live_component @socket, ArbitronWeb.BarChartComponent, id: 3 %>
      </article>
      <article class="column">
        <%= live_component @socket, ArbitronWeb.BarChartComponent, id: 4 %>
      </article>
    </section>
    """
  end
